...
| **InvMove** | Te permite caminar, correr y saltar libremente por el mundo mientras tienes abierto cualquier menú, cofre o inventario. |
| **NameProtect** | Oculta tu verdadero nombre en la interfaz de usuario, sobre tu cabeza y en el chat para facilitar grabar en anonimato. |
...
| Módulo | Descripción Exacta |
|---|---|
| **BlockESP** | Resalta e ilumina el contorno de bloques específicos y de tu interés (como diamantes o spawners) viéndose a través de los muros. |
...
| Módulo | Descripción Exacta |
|---|---|
| **AntiWeather** | Intercepta paquetes del clima y oculta a nivel visual y auditivo los molestos efectos de lluvia, nieve y los relámpagos. |
| **AutoFarm** | Rompe cultivos completamente maduros a tu alrededor, recogiendo lo que sueltan y volviéndolos a plantar instantáneamente. |
...
| **FastPlace** | Anula los límites y el retraso del juego al colocar bloques o arrojar ítems, permitiendo construir inmensos puentes a una velocidad irreal. |
...
| **TimeChanger** | Congela y modifica a voluntad la hora del día (Día, Mediodía, Noche) exclusivamente en tu pantalla sin afectar la del servidor. |
...
| **Waypoints** | Te permite añadir marcas en tus ubicaciones importantes, que se guardan y se muestran con indicadores visuales gigantes en el mundo 3D. |
